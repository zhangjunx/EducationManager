	 ...
	 var $ = layui.$,
	  ...
	  table.render({
		    ...
		    cols: [[
		      ...
		      {field:'REMARK', title:'当日最高体温', width:150,},
		      {field:'REMARK', title:'当日最低体温', width:150,},
		      ...
		      {fixed: 'right', title:'操作',width:120, templet:function(d){
	    		  return "<a class='layui-btn layui-btn-normal layui-btn-xs' lay-event='edit'><i class='layui-icon layui-icon-edit'></i>详情</a>";
	           }}
		    ]],
		    page: true
		  });
