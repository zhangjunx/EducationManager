	 ...
	 var $ = layui.$,
	  ...
	  table.render({
		    ...
		    cols: [[
		      ...
		      {field:'HEARTRATE', title:'心率', width:110,},
		      {field:'BLOODMAX', title:'最高血压', width:110,},
		      {field:'BLOODMIN', title:'最低血压', width:105,},
		      {field:'UPLOADDATE', title:'日期', width:250,},
	  ...
	  table.on('tool(LAY-user-manage)', function(obj){
		...
		if(obj.event === 'edit'){
		    	 layer.open({
			    	 type:2,
			    	 title:"心率血压记录",
			    	 content:"bphrtRecord_details.html?fid="+data.STUDENTID+"&date="+data.UPLOADDATE+"",
			    	 area:["90%","91%"],
			     })
		      }
		});
