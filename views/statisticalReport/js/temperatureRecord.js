	 ...
	 var $ = layui.$,
	  ...
	  table.render({
		    ...
		    cols: [[
		      ...
		      {field:'TEMP', title:'体温', width:200,},
		      {field:'UPLOADDATE', title:'日期', width:250,},
		      {fixed: 'right', title:'操作',width:230, templet:function(d){
	  ...
	  table.on('tool(LAY-user-manage)', function(obj){
		...
		if(obj.event === 'edit'){
		    	 layer.open({
			    	 type:2,
			    	 title:"体温记录",
			    	 content:"temperatureRecord_details.html?fid="+data.STUDENTID+"&date="+data.UPLOADDATE+"",
			    	 area:["90%","91%"],
			     })
		    }
		  });
