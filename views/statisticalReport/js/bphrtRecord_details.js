	 ...
	 var $ = layui.$,
	  ...
	  table.render({
		    ...
		    cols: [[
		      ...
		      {field:'HEARTRATE', title:'心率', width:200,},
		      {field:'BLOODMAX', title:'最高血压', width:200,},
		      {field:'BLOODMIN', title:'最低血压', width:200,},
		      {field:'UPLOADDATE', title:'日期', width:210,}
		    ]],
		    page: true
		  });
})
