	      ...
	      layer.confirm('确定删除?', function(index){
	        $.ajax({
	    	 ...
	    	 layer.open({
		    	 type:2,
		    	 title:"修改班级",
		    	 content:"class_add.html?fid="+data.FID,
		    	 area:["90%","91%"],
		     })
	    }
	  });
